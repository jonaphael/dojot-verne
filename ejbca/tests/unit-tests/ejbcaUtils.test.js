...
describe('Testing EJBCA Utils functionalities', () => {
  ...
  describe('Testing createMessenger', () => {
    it('Should fail creating a messenger', () => {
      const error = 'error';
      const mockedMessenger = { init: jest.fn(() => Promise.reject(error)) };
    ...
    it('Should create a messenger and set listeners ', () => {
      const dojotConfigMock = { dojot: { subjects: { devices: 'device' } } };
      const mockedSoap = { editUser: jest.fn((args, callback) => callback(null)) };

      const mockedDeviceUser = {
        event: 'event',
        meta: { service: 'service' },
        data: { id: 'id' },
      };

      const mockedMessenger = {
    ...
    it('Should create a messenger and not set listeners ', () => {
      const dojotConfigMock = { dojot: { subjects: { devices: 'device' } } };
      const mockedSoap = { editUser: jest.fn((args, callback) => callback('err')) };
